    ...
    <>
        ...
        >
          ...
          >
            ...
            <span className="debug-line-label debug-line-label-bottom">
              视口下边界 (第 {Math.min(viewportEnd, flatList.length).toLocaleString()} 行)
            </span>
          </div>
      ...
      <div className="debug-panel">
        ...
        <div className="debug-panel-grid">
          ...
          <span className="debug-panel-value">
            [{viewportStart.toLocaleString()}, {Math.min(viewportEnd, flatList.length).toLocaleString()})
          </span>
        ...
        <div className="debug-panel-legend">
          <div className="debug-legend-item">
            <span className="debug-legend-swatch" style={{ background: '#fff', border: '1px solid #d9d9d9' }} />
            视口内 (VISIBLE)
          </div>
          <div className="debug-legend-item">
            <span className="debug-legend-swatch" style={{ background: '#fff7e6', border: '1px solid #ffd591' }} />
            上缓冲区 (BUFFER)
          </div>
          <div className="debug-legend-item">
            <span className="debug-legend-swatch" style={{ background: '#e6f7ff', border: '1px solid #91d5ff' }} />
            下缓冲区 (BUFFER)
          </div>
          <div className="debug-legend-item">
